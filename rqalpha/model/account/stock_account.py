...
class StockAccount(BaseAccount):
    def __init__(self, total_cash, positions, backward_trade_set=set(), dividend_receivable=None, register_event=True, account_id=None):
        super(StockAccount, self).__init__(total_cash, positions, backward_trade_set, register_event, account_id)
